...
version: 1
summary: Review the drafted Definition of Done and implementation planning package,
  record findings and remediation decisions, and determine whether the plan is ready
  to move into downstream handoff.
...
- A Definition of Done, implementation strategy, and sequencing plan all exist and need a readiness review.
...
1. Read the instantiated Definition of Done, implementation strategy, and sequencing artifact together with the architecture and requirements handoffs, using relevant security/compliance artifacts as needed to judge planning traceability honestly.
...
4. Review the package for coherence, readiness, missing support, hidden dependencies, unsupported assumptions, sequencing weaknesses, Definition-of-Done drift, and role drift.
...
- If the implementation strategy or handoff silently redefines the Definition of Done, route remediation back to the earliest planning artifact that introduced the drift.
