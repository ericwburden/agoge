...
- Required:
  - [`artifacts/business-objectives.md`](D:/Projects/agoge/artifacts/business-objectives.md)
  - [`artifacts/process-analysis.md`](D:/Projects/agoge/artifacts/process-analysis.md)
- Optional: additional research, stakeholder clarifications, policy references, and prior specs.

## Outputs

- Primary artifacts:
  - [`artifacts/requirements-specification.md`](D:/Projects/agoge/artifacts/requirements-specification.md)
  - [`artifacts/requirements-handoff.md`](D:/Projects/agoge/artifacts/requirements-handoff.md)
...
3. Use `requirements-verification` to determine which requirements are confirmed, separate non-requirements and unresolved items, and populate [`artifacts/requirements-specification.md`](D:/Projects/agoge/artifacts/requirements-specification.md).
4. Use `handoff-packaging` to build [`artifacts/requirements-handoff.md`](D:/Projects/agoge/artifacts/requirements-handoff.md) with traceability, risks, dependencies, unresolved questions, and downstream decision points.
5. If the handoff is mature and the next step is implementation planning, use `spec-to-implementation` as a downstream bridge rather than extending BA discovery further.
...
- Verified requirements are clear, scoped, and traceable to business goals or process needs.
- Non-requirements, assumptions, and unresolved questions are explicitly separated.
- Risks, dependencies, and next decision points are visible to downstream roles.
- The handoff package is sufficient for product, architecture, delivery, or implementation roles to continue without reconstructing the business context.
